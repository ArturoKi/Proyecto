              ...
              <table class="responsive-table">
                ...
                <?php while($f = $sel->fetch_assoc()){?>
                  <tr>
                    ...
                    <td>
                      <?php if($f['bloqueo']==1):?>
                        <a href="../extend/bloqueo_man.php?id=<?php echo $f['id_usuario'] ?>&bl=<?php echo $f['bloqueo'] ?>&t=user">
                    ...
                    <td>
                      <a class="btn blue lighten-2 modal-trigger" href="#modal_<?php echo $f['id_usuario']?>">Detalles</a>
                    </td>
                  </tr>
                <?php 
                include '../extend/modal_u.php';
                }?>
                </tbody>
              </table>
            </div>
