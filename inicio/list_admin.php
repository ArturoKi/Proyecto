...
$sel = $con->query("SELECT * FROM administrador");
              ...
              <table class="responsive-table">
                ...
                <?php while($f = $sel->fetch_assoc()){?>
                  <tr>
                    ...
                    <td>
                      <?php if($f['bloqueo']==1):?>
                        <a href="../extend/bloqueo_man.php?id=<?php echo $f['id_admin'] ?>&bl=<?php echo $f['bloqueo'] ?>&t=admin">
                    ...
                    <td>
                      <a class="btn blue lighten-2 modal-trigger" href="#modal_<?php echo $f['id_admin']?>">Detalles</a>
                    </td>
                  </tr>
                <?php 
                include '../extend/modal_admin.php';
                }?>
                </tbody>
              </table>
            </div>
